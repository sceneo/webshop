            ...
            <Grid container spacing={1}>
                <Grid item sm={6} >
                    ...
                    <p className={"mainText"}>
                        ...
                        <div>
                            Suchst du ein individuelles Geschenk für deine Liebsten oder ein einzigartiges Kleidungsstück
                            oder Accessoire nur für dich? Dann bist du hier genau richtig!
                        </div>
                        <div>
                            Von der Stoffauswahl, dem Anpassen des Schnittmusters bis hin zum Zuschneiden und Nähen – ich
                            fertige dein eigenes Unikat mit viel Liebe und Herzblut.
                        </div>
                        <div>
                            Schau dich um und nimm gerne Kontakt auf – ich freue mich schon darauf, dir und deinen Liebsten
